...
Ce programme java va afficher un sapin couché de 5 étoiles comme taille 
Pour compiler et faire fonctionner ce programme il faut d'abord utiliser maven
en premier on peut utiliser mvn clean pour ne rien avoir au début puis mvn compile pour voir si ca fonctionne puis il faut faire mvn packahge puis java -jar target/tp_qualite-1.0.jar, enfin pour generer la javadoc il faut utilisé mvn javadoc:javadoc
Le programme se lancera et affichera un sapin puis "ca a fonctionné"
